...
<body>
        ...
        <ul>
         ...
         <div class="dropdown">
			  ...
			  <div class="dropdown-content">
				...
				<a class="active" href="ThongKeViView.php">Thống kê theo Ví</a> 
	...
	<article>
	  <h1>THỐNG KÊ THEO VÍ </h1>
		<?php
		include("connectdb.php");
	$sqlchi = "SELECT * from list_accounts";
    $result1 = $conn->query($sqlchi);

    if ($result1->num_rows > 0) {
        echo "<h3>Thống kê theo ví</h3>";
        echo "<table>";
        echo "<tr><th>Tên ví</th><th>Số dư</th></tr>";
		$categories1 = [];
        $totals1 = [];
		$thu=[];
        while ($row1 = $result1->fetch_assoc()) {
            array_push($categories1, $row1["name_acc"]);
            array_push($totals1, $row1["money_acc"]);
            echo "<tr><td>".$row1["name_acc"]."</td><td>".$row1["money_acc"]."</td></tr>";
        }
        echo "</table>";

...
<body>
	...
	<article id="dsgd">
	  <h1>Danh sách các ví</h1>
		<table id="table_right_trangchu" border="1">		
			<tr>
					<th width="15%">Tên ví</th>
					<th width="15%">Số tiền Thu</th>
					<th width="15%">Số tiền chi</th>
					<th width="20%">Số tiền còn lại</th>
					<th width="10%">Tùy chọn</th>
			</tr>
		<?php
		include("connectdb.php");
		$chi="Select * from list_accounts";
		$result = $conn->query($chi);
		...
		<tr>
					...
					<td><?php echo $row["money_acc"]?></td>
					<td><a href="DelVi.php?id_acc=<?php echo $row["id_acc"]?>">Xóa</a></td>
			</tr>
		<?php
		}
	}

...
<body>
	...
	$sql_select_type="Select * from `danhmuc` where danhmuc.kieu='Thu'";
           ...
           <li><a class="dropdown"href="TrangChuLogin.php">Trang chủ</a></li>
			  <div class="dropdown">
				  ...
				  <div class="dropdown-content">
					<a class="active"  href="AddThuNhap.php">Thu-Income</a>
...
<article id="article">
        ...
        <form id="addTransactionForm" action="SaveGDThu.php" method="post" enctype="multipart/form-data">
			<h3 id="thu">THU NHAP</h3>
            <h4>Thời gian</h4>
		...
		<form action="SaveDanhMucThu.php" id="Add2">
